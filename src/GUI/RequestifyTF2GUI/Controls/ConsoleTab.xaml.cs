...
namespace RequestifyTF2GUI.Controls
{
    ...
    public partial class ConsoleTab : UserControl
    {
        ...
        public ConsoleTab()
        {
            Requestify._writer.WriteLineEvent += _writer_WriteLineEvent;
            Requestify._writer.WriteEvent += _writer_WriteEvent;
            instance = this;
            InitializeComponent();
        }

        private void _writer_WriteEvent(object sender, RequestifyConsoleHookArgs e)
        {
            Console.Text += e.Value;
        }

        private void _writer_WriteLineEvent(object sender, RequestifyConsoleHookArgs e)
        {
        ...
        {
            if (debugchk.IsChecked != null) Requestify.Debug = debugchk.IsChecked.Value;
        }
