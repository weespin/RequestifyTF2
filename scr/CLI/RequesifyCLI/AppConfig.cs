    ...
    internal static class AppConfig
    {
        ...
        public static void Load()
        {
            ...
            if (Directory.Exists(Path.GetDirectoryName(AppDomain.CurrentDomain.BaseDirectory) + "/config/"))
            {
                ...
                {
                    File.WriteAllText(Path.GetDirectoryName(AppDomain.CurrentDomain.BaseDirectory) + "config/config.json",
                        emptyjson);
        ...
        public static void Save()
        {
            ...
            File.WriteAllText(Path.GetDirectoryName(AppDomain.CurrentDomain.BaseDirectory) + "/config/config.json", currentconfig);
        }
    }
